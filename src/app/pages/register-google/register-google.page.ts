...
export class RegisterGooglePage {
  ...
  constructor(
    ...
    private readonly supabaseService: FirestoreService,
...
async registerUserWithGoogle() {
  try {
    ...
    const response = await this.supabaseService.registerGoogleUser(this.email, this.password, this.verificado);
